...
define('PAYTM_MERCHANT_WEBSITE', 'xxxxxxx'); //Change this constant value with Website name received from Paytm.
...
define('CALLBACK_URL', 'http://localhost/HBWEBSITE/pay_response.php'); //change this constant with callback url given by paytm
