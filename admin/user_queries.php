    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto overflow-hidden p-1 mt-3">
                <h3 class="mt-3">User Queries</h3>
                <!-- carousel section   -->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <a href="?seen=all" class="btn btn-dark rounded shadow-none btn-sm"><i class="bi bi-check-all"></i> Mark as read</a>
                            <a href="?delete=all" class="btn btn-dark rounded shadow-none btn-sm"><i class="bi bi-trash3-fill"></i> Delete all</a>
                        </div>
                            ...
                            <table class="table table hover border">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        ...
                                        $seen .= "<a href='?delete=$row[sr_no]' class='btn btn-sm rounded btn-danger mt-2' >Delete</a>";
                                        echo <<<data
                                        <tr>
                                            <td>$i</td>
                                            <td>$row[name]</td>
